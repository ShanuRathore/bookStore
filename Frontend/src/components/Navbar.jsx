      ...
      <div className="navbar ">
        <div className="navbar-start">
          <div className="dropdown ">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 dark:bg-slate-800 dark:text-slate-200 "
            >
              {navItems}
              <li>
                <a>Types..</a>
        ...
        <div className="navbar-end space-x-3">
          ...
          <div className="hidden md:block">
            <label className=" flex items-center gap-2  px-3 py-2 border rounded-md">
              <input
                type="text"
                className="grow outline-none px-1  dark:bg-slate-900 dark:text-slate-200 "
                placeholder="Search"
              />
              <svg
                xmlns="http://www.w3.org/2000/svg"
